        ...
        <input
          ...
          className={cn(
            ...
            error
              ...
              : 'border-slate-300 focus-visible:ring-zavia-navy',
            className
          )}
          {...props}
        />
    ...
    return (
      <div className="w-full">
        ...
        <textarea
          ...
          ref={ref}
          className={cn(
            'flex min-h-[120px] w-full rounded-md border bg-white px-3 py-2 text-sm ring-offset-white placeholder:text-slate-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50',
            error
              ? 'border-red-500 focus-visible:ring-red-500'
              : 'border-slate-300 focus-visible:ring-zavia-navy',
            className
